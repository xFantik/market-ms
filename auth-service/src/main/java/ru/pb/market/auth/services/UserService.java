package ru.pb.market.auth.services;
...
import ru.pb.market.auth.repositoties.RoleRepository;
import ru.pb.market.auth.repositoties.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    public void createUser(User user) {
        ...
        if (userRepository.findUserByUsername(user.getUsername()).isPresent())
            throw (new RuntimeException("Имя " + user.getUsername() + " занято"));
